...
/**
 * Alias-Typ für gültige Strings bei Markenn.
 */
export type Marke = 'AUDI' | 'BMW';

/**
 * Alias-Typ für gültige Strings bei der Typ eines Autos.
 */
export type AutoTyp = 'COUPE' | 'LIMOUSINE';
...
export interface Auto {
    ...
    readonly klimabilanz: number | null | undefined;
    ...
    readonly spezifikationen?: string[];
    readonly herstellungsorte: unknown;
}
