...
export class AutoRequestHandler {
     ...
     * gesetzt und genauso auch wenn das Modell oder die Modell-Nummer bereits
     * existieren.
     *
     * @param req Request-Objekt von Express.
     * @param res Leeres Response-Objekt von Express.
     ...
     * Modell oder die neue Modell-Nummer bereits existieren.
     *
     * @param req Request-Objekt von Express.
     * @param res Leeres Response-Objekt von Express.
     * @returns Leeres Promise-Objekt.
    ...
    private handleCreateError(err: CreateError, res: Response) {
        ...
        if (err instanceof ModellnrExists) {
            this.handleModellnrExists(err.modellnr, err.id, res);
        }
    }

    private handleModellnrExists(
        modellnr: string | null | undefined,
        id: string | undefined,
        res: Response,
    ) {
        const msg = `Die Modell-Nummer "${modellnr}" existiert bereits bei ${id}.`;
        logger.debug('AutoRequestHandler.handleModellnrExists(): msg=%s', msg);
