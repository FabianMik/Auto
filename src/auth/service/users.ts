...
export const users: User[] = [
    ...
    },
    {
        ...
        username: 'adriana.alpine',
        password,
        email: 'adriana.alpine@acme.com',
        roles: ['admin', 'mitarbeiter', 'kunde'],
    },
    {
        id: '20000000-0000-0000-0000-000000000003',
        username: 'alfred.alpine',
        password,
        email: 'alfred.alpine@acme.com',
        roles: ['mitarbeiter', 'kunde'],
    },
    {
        id: '20000000-0000-0000-0000-000000000004',
        username: 'antonia.alpine',
        password,
        email: 'antonia.alpine@acme.com',
        roles: ['mitarbeiter', 'kunde'],
    },
    {
        id: '20000000-0000-0000-0000-000000000005',
        username: 'dirk.diesel',
        password,
        email: 'dirk.diesel@acme.com',
        roles: ['kunde'],
    },
    {
        id: '20000000-0000-0000-0000-000000000006',
        username: 'emilia.erlkoenig',
        password,
        email: 'emilia.erlkoenig@acme.com',
    },
];
